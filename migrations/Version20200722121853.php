 ...
 */
final class Version20200722121853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, performance_id INT DEFAULT NULL, comment VARCHAR(255) NOT NULL, rate INT DEFAULT NULL, INDEX IDX_9474526CB91ADEEE (performance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
